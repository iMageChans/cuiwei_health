...
export const metadata = {
    ...
    twitter: {
        ...
        title: 'Meditation Benefits | Impulse',
        description: 'Discover the numerous benefits of meditation for stress management and overall well-being',
        site: 'https://heartwellness.app/knowledge/health/meditation-benefits',
        images: [
            {
                url: 'https://heartwellness.app/open-graph.png',
                width: 1200,
